@extends('admin.layouts.master', ['title' => 'Thêm thành viên'])
@push('styleAdmin')
            ...
            <div class="form-row">
                <div class="col-md-7 pr-5">
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control" placeholder="Nhập tên thành viên"
                               value="{{ old('name') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input name="re_password" type="password" class="form-control" placeholder="Nhập mật khẩu"
                               value="">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <img id="output_img" src="{{ asset('assets/admin/img/default-avatar.png') }}" style="width: 250px">
                    </div>
                </div>
