          ...
          @foreach ($productType as $key => $value)
            <tr class="rowTable{{$value->id}}">
              ...
              <td>
                ...
                <button type="button" title="Xóa" data-toggle="modal" data-target="#delPrTypeModal" class="btn btn-sm ml-2 btn-outline-danger delPrTypeJS" data-id="{{ $value->id }}" data-name="{{$value->name}}">
